...
def new_conv_layer(input, num_input_channels, filter_size, num_filters, use_pooling=True,use_dropout=False):
    ...
    if use_dropout:
        ...
        drop_layer = tf.nn.dropout(layer, keep_prob)
        return drop_layer,weights
...
# second conv layer
convlayer2, w2 = new_conv_layer(convlayer1, 30, 3, 50,True,True)
#third conv layer

convlayer3,w3=new_conv_layer(convlayer2,50,3,30,True,True)
